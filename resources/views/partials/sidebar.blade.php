  ...
  <div class="sidebar">
    ...
    <nav class="mt-1">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        @if ($user->role == 'admin')
        <!-- 1. Data Master -->
        <li class="nav-item has-treeview {{ Request::is('admin/jurusan*') || Request::is('admin/importDataMaster*') || Request::is('admin/level*') || Request::is('admin/kelas*') || Request::is('admin/mapel*') || Request::is('admin/siswa*') || Request::is('admin/dataAlumni*') || Request::is('admin/guru*') || Request::is('admin/dataMaster/*') ? 'menu-open' : '' }}">
          <a href="#" class="nav-link {{ Request::is('admin/jurusan*') || Request::is('admin/importDataMaster*') || Request::is('admin/level*') || Request::is('admin/kelas*') || Request::is('admin/mapel*') || Request::is('admin/siswa*') || Request::is('admin/dataAlumni*') || Request::is('admin/guru*') || Request::is('admin/dataMaster/*') ? 'active' : '' }}">
        ...
        <!-- 3. Absensi Siswa -->
        <li class="nav-item has-treeview {{ Request::is('admin/absensi') || Request::is('admin/rekapAbsen') || Request::is('admin/rekapAbsenSiswa') || Request::is('admin/rekap-belum-absen') || Request::is('admin/dataAbsen') ? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{ Request::is('admin/absensi') || Request::is('admin/rekapAbsen') || Request::is('admin/rekapAbsenSiswa') || Request::is('admin/rekap-belum-absen') || Request::is('admin/dataAbsen') ? 'active' : '' }}">
        ...
        <li class="nav-item has-treeview {{ Request::is('admin/guruPiket*') ? 'menu-open' : '' }}">
          ...
          <ul class="nav nav-treeview">
            ...
            <li class="nav-item" style="font-size: 14px">
              <a href="/admin/guruPiket" class="nav-link {{ Request::is('admin/guruPiket') && !Request::is('admin/guruPiket/panel') ? 'active' : '' }}">
        ...
        <!-- 6. Point Siswa -->
        <li class="nav-item has-treeview {{ Request::is('admin/point') || Request::is('admin/pointSiswa') ? 'menu-open' : '' }}">
          <a href="#" class="nav-link {{ Request::is('admin/point') || Request::is('admin/pointSiswa') ? 'active' : '' }}">
        ...
        <!-- 3. Absensi Siswa -->
        <li class="nav-item has-treeview {{ Request::is('admin/absensi') || Request::is('admin/dataAbsen') ? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{ Request::is('admin/absensi') || Request::is('admin/dataAbsen') ? 'active' : '' }}">
              <i class="nav-icon fas fa-clipboard-list"></i>
              <p>
                Absensi Siswa
                <i class="right fas fa-angle-left"></i>
        ...
        <!-- 3. Absensi Siswa -->
        <li class="nav-item has-treeview {{ Request::is('admin/absensi') || Request::is('admin/rekapAbsen') || Request::is('admin/rekapAbsenSiswa') || Request::is('admin/dataAbsen') ? 'menu-open' : '' }}">
            <a href="#" class="nav-link {{ Request::is('admin/absensi') || Request::is('admin/rekapAbsen') || Request::is('admin/rekapAbsenSiswa') || Request::is('admin/dataAbsen') ? 'active' : '' }}">
                <i class="nav-icon fas fa-clipboard-list"></i>
                <p>
                    Absensi Siswa
                    <i class="right fas fa-angle-left"></i>
