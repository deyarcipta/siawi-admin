            ...
            <form action="/admin/level" method="POST">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="kode_level" placeholder="Enter Kode level" name="kode_level" value="{{old('kode_level')}}">
                  @error('kode_level')
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama_level" placeholder="Enter Nama level" name="nama_level" value="{{old('nama_level')}}">
                  @error('nama_level')
                    <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
                </div>
