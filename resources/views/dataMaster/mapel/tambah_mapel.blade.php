            ...
            <form action="/admin/mapel" method="POST">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="kode_mapel" placeholder="Enter Kode Mapel" name="kode_mapel" value="{{old('kode_mapel')}}">
                  @error('kode_mapel')
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="nama_mapel" placeholder="Enter Nama Mapel" name="nama_mapel" value="{{old('nama_mapel')}}">
                  @error('nama_mapel')
                    <div class="alert alert-danger">{{ $message }}</div>
                  @enderror
                </div>
