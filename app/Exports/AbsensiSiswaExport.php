...
class AbsensiSiswaExport implements FromCollection, WithHeadings, WithMapping, WithStyles, WithTitle, ShouldAutoSize, WithEvents
{
    protected $tanggal;
    protected $data;
    ...
    {
        return [
            ['Rekap Harian Siswa SMK WISATA INDONESIA'],
            [], // Judul
            ['No', 'Nama Siswa', 'Hari', 'Tanggal', 'Jam Masuk', 'Jam Pulang', 'Kehadiran'] // Header tabel tanpa Keterangan
        ];
    }
